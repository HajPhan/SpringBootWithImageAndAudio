...
import com.example.SpringBoot_ToiecDemo.service.FileStorageService;
...
public class FileController {
    ...
    public List<UploadFileResponse> uploadFileMultipleFiles(@RequestParam("files") MultipartFile[] files) {
